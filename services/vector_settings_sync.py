...
async def sync_settings_index(
    ...
    *,
    ...
    try:
        ...
        print(f"[VectorStore] Failed to list setting ids: {exc}")
    ...
    if to_delete:
        try:
            ...
            print(f"[VectorStore] Failed to delete orphan setting ids: {exc}")
...
async def index_settings(
    ...
    try:
        ...
        print(f"[VectorStore ERROR] index_settings failed: {exc}")
