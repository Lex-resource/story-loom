    ...
    if (this.state.hasError) {
      return (
        <div style={{
          ...
          backgroundImage: 'radial-gradient(circle at 20% 80%, rgba(184, 134, 11, 0.03) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(194, 58, 43, 0.03) 0%, transparent 50%)',
          padding: '24px',
